...
def test_mean_impute_throws_error_non_numerical():
...
def test_median_impute_no_copy():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute_num.csv")
...
def test_median_impute_throws_error_non_numerical():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute.csv")
...
def test_most_frequent_impute_no_copy():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute.csv")
...
def test_most_frequent_impute_copy():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute.csv")
...
def test_most_frequent_impute_subset():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute.csv")
...
def test_knn_impute_non_numerical_data():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute.csv")
    adata_imputed = knn_impute(adata, n_neighbours=3, copy=True)
...
def test_knn_impute_numerical_data():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute_num.csv")
...
def test_missforest_impute_non_numerical_data():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute.csv")
...
def test_missforest_impute_numerical_data():
...
def test_missforest_impute_subset():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute_num.csv")
...
def test_missforest_impute_dict():
    warnings.filterwarnings("ignore", category=ConvergenceWarning)
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute.csv")
    adata_imputed = miss_forest_impute(
...
def test_soft_impute_non_numerical_data():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute.csv")
    adata_imputed = soft_impute(adata)
...
def test_soft_impute_numerical_data():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute_num.csv")
    adata_imputed = soft_impute(adata)
...
def test_IterativeSVD_impute_no_copy():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute_num.csv")
...
def test_IterativeSVD_impute_copy():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute_num.csv")
...
def test_IterativeSVD_impute_non_numerical_data():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute.csv")
...
def test_IterativeSVD_impute_numerical_data():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute_num.csv")
    adata_imputed = iterative_svd_impute(adata, rank=2)
...
def test_IterativeSVD_impute_list_str():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute.csv")
...
def test_matrix_factorization_impute_no_copy():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute_num.csv")
...
def test_matrix_factorization_impute_copy():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute_num.csv")
...
def test_matrix_factorization_impute_non_numerical_data():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute.csv")
    adata_imputed = matrix_factorization_impute(adata)
...
def test_matrix_factorization_impute_numerical_data():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute_num.csv")
    adata_imputed = matrix_factorization_impute(adata)
...
def test_matrix_factorization_impute_list_str():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute.csv")
...
def test_nuclear_norm_minimization_impute_no_copy():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute_num.csv")
...
def test_nuclear_norm_minimization_impute_copy():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute_num.csv")
...
def test_nuclear_norm_minimization_impute_non_numerical_data():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute.csv")
    adata_imputed = nuclear_norm_minimization_impute(adata)
...
def test_nuclear_norm_minimization_impute_numerical_data():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute_num.csv")
    adata_imputed = nuclear_norm_minimization_impute(adata)
...
def test_nuclear_norm_minimization_impute_list_str():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute.csv")
...
def test_miceforest_impute_no_copy():
...
@pytest.mark.skipif(os.name == "posix", reason="miceforest Imputation not supported by MacOS.")
def test_miceforest_impute_copy():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute_iris.csv")
...
@pytest.mark.skipif(os.name == "posix", reason="miceforest Imputation not supported by MacOS.")
def test_miceforest_impute_non_numerical_data():
...
@pytest.mark.skipif(os.name == "posix", reason="miceforest Imputation not supported by MacOS.")
def test_miceforest_impute_numerical_data():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute_iris.csv")
    adata_imputed = mice_forest_impute(adata)
...
@pytest.mark.skipif(os.name == "posix", reason="miceforest Imputation not supported by MacOS.")
def test_miceforest_impute_list_str():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute_titanic.csv")
...
def test_explicit_impute_subset():
    adata = read_csv(dataset_path=f"{_TEST_PATH}/test_impute.csv")
