...
def test_heatmap_plot(adata_mini, check_same_image):
    ax_dict = ep.pl.heatmap(adata_mini,
...
def test_tracks_plot(mimic_2, check_same_image):
    adata_sample = mimic_2[:200, ["age", "gender_num", "weight_first", "bmi", "sapsi_first", "day_icu_intime_num", "hour_icu_intime"]].copy()
    ...
    ax = ep.pl.tracksplot(adata_sample, var_names=["age",
                                                    "gender_num",
                                                    "weight_first",
                                                    "bmi",
                                                    "sapsi_first",
...
def test_matrix_plot(mimic_2, check_same_image):
    adata_sample = mimic_2[:200, ["abg_count",
                                  "wbc_first",
                                  "hgb_first",
                                  "potassium_first",
                                  "tco2_first",
    ...
    ax = ep.pl.matrixplot(adata_sample,
                          var_names=[
                              "abg_count",
                              "wbc_first",
                              "hgb_first",
...
def test_stacked_violin_plot(mimic_2, check_same_image):
    ...
    ax = ep.pl.stacked_violin(adata_sample,
                     var_names=
                        ["icu_los_day",
                        "hospital_los_day",
                        "age",
...
def test_clustermap(mimic_2_encoded, check_same_image):
    adata_sample = mimic_2_encoded[:200, ["abg_count",
                                "wbc_first",
                                "hgb_first"]].copy()
...
def test_rank_features_groups_heatmap(mimic_2_encoded, check_same_image):
    adata_sample = mimic_2_encoded[:200, [
                                   "wbc_first",
                                   "hgb_first",
                                   "potassium_first",
                                   "tco2_first",
...
def test_rank_features_groups_dotplot(mimic_2_encoded, check_same_image):
    adata_sample = mimic_2_encoded[:200, ["wbc_first",
                                          "hgb_first",
                                          "potassium_first",
                                          "tco2_first",
                                          "bun_first"]].copy()
    ep.tl.rank_features_groups(adata_sample, groupby="service_unit")
    ax = ep.pl.rank_features_groups_dotplot(adata_sample, key="rank_features_groups", groupby="service_unit", show=False)
...
def test_rank_features_groups_tracksplot(mimic_2_encoded, check_same_image):
    adata_sample = mimic_2_encoded[:200, ["age",
                                "gender_num",
                                "weight_first",
                                "bmi",
                                "sapsi_first",
